...
--theme.menu.border_color = "#444444"
...
theme.wallpaper = os.getenv("HOME") .. "/.config/awesome/themes/aish/background.jpg"
...
theme.awesome_icon = "~/Downloads/archlogo/blue.png" -- "/usr/share/awesome/icons/awesome16.png"
